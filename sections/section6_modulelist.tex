本システムのモジュール一覧を表\ref{tab:commonmodule}から\ref{tab:adminmodule}に示す．モジュールIDはM(共通:1，利用者:12事業者:3，管理者:4)-(各機能の番号)-(もし，同じ機能で分けられているモジュールがあるならば，仕様順番の番号)となっている．
...
\begin{longtable}{|c|c|>{\hspace{0pt}\centering\arraybackslash}p{5cm}|}
    ...
    \hline
        ...
        M1-1 & LoginScreen & ログイン画面を表示 \\ \hline
        M1-2 & FetchMemerInfo & 会員情報を取得 \\ \hline
        ...
        M1-7-3 & ShowPinnedPosts & ピンに投稿されている内容を表示 \\ \hline
        M1-7-4 & DisplayPostList & 投稿閲覧画面を表示 \\ \hline
        ...
        M1-11-1 & UserBlockViewScreen & ブロックリストを表示 \\ \hline
        M1-11-2 & GetBlockList & ブロックリストを表示 \\ \hline
        ...
        M1-15-2 & DisplayUserSetteing & 設定を表示 \\ \hline
\end{longtable}
...
\begin{longtable}{|c|c|>{\hspace{0pt}\centering\arraybackslash}p{5cm}|}
    ...
    M2-3-1 & UserDeleteInformation & 会員情報を匿名化する \\ \hline
    M2-4-1 & UserInputSearchKeyword & キーワードを入力する \\ \hline
    M2-4-2 & SearchKeyword & キーワード検索をする \\ \hline
    M2-4-3 & UserDisplayKeywordSearchResults & キーワード検索の結果を表示 \\ \hline
    M2-5-1 & UserSelectSearchGenre & ジャンルを選択 \\ \hline
    M2-5-2 & SearchGenre & ジャンル検索をする \\ \hline
    M2-5-3 & UserDisplayGenreSearchResults & ジャンル検索結果を表示 \\ \hline
    M2-6-1 & UserSelectSearchPeriod & 期間を選択 \\ \hline
    M2-6-2 & SearchPeriod & 期間検索をする \\ \hline
    M2-6-3 & UserDisplayPeriodSearchResults & 期間検索の結果を表示\\ \hline
    M2-7 & UserDeletePinDetail & 投稿内容を匿名化 \\ \hline
    M2-8-1 & UserTriggerReaction & リアクションボタンを押す \\ \hline
    M2-8-2 & UserInputReactionInformation & リアクション情報を格納 \\ \hline
    M2-9-1 & UserInputBusinessApplication & 事業者申請を入力 \\ \hline
    M2-9-2 & InputBusinessRequestInformation & 事業者申請を格納 \\ \hline
    M2-10-1 & UserGetReactionList & リアクション履歴を取得 \\ \hline
    M2-10-2 & UserReactionViewScreen & リアクション履歴を表示 \\ \hline
\end{longtable}
...
\begin{longtable}{|c|c|>{\hspace{0pt}\centering\arraybackslash}p{5cm}|}
    ...
    M3-4-2 & UpdateBusinessName & 事業者名の変更を反映する \\ \hline
