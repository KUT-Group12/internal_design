...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|} \hline
        カラム名 & PK & FK & その他の制約 & 論理データ型 & 説明 \\ \hline\hline
        blockId & ○ & & not null & INT & ブロックID \\ \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|} \hline
        カラム名 & PK & FK & その他の制約 & 論理データ型 & 説明 \\ \hline\hline
        askId & ○ & & not null & INT & 問い合わせID \\ \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|} \hline
        カラム名 & PK & FK & その他の制約 & 論理データ型 & 説明 \\ \hline\hline
        reportId & ○ & & not null & INT & 通報ID \\ \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|} \hline
        カラム名 & PK & FK & その他の制約 & 論理データ型 & 説明 \\ \hline\hline
        requestId & ○ & & not null & INT & 事業者申請ID \\ \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|} \hline
        カラム名 & PK & FK & その他の制約 & 論理データ型 & 説明 \\ \hline\hline
        reactionId & ○ & & not null & INT & リアクションID \\ \hline
